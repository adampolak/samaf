...
\cite{bordewich2005,ShiFYW16,KelkLM23}.
...
subinstances~\cite{Kelk26}.  Our heuristic does not solve these variants.  It simply solves
...
The cluster decomposition and early cut heuristic can
...
Other tested approaches---which we eventually abandoned becuase initial implementations
worked poorly compared to simulated annealing---included: Monte Carlo tree search, SAT, and ILP, with the last two used both as end-to-end solvers and large-neighborhood local search heuristics.
